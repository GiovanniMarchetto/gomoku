...
class NonNegativeIntegerTest {
    ...
    private final static String NON_NEGATIVE_INTS_PROVIDER_RESOURCE_LOCATION = "/nonNegativeInts.csv";
    private final static String COUPLE_OF_NON_NEGATIVE_INTS_PROVIDER_RESOURCE_LOCATION = "/coupleInts.csv";
    ...
    @ParameterizedTest
    @CsvFileSource(resources = NON_NEGATIVE_INTS_PROVIDER_RESOURCE_LOCATION)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = COUPLE_OF_NON_NEGATIVE_INTS_PROVIDER_RESOURCE_LOCATION)
